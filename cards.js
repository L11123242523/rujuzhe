window.__CARD_DATA__ = {
  ...
  "characters": [
    ...
    },
    {
      "name": "琉璃(水着)",
      "attribute": "热忱",
      "passive": "为君绽放的微笑：使用热忱属性的卡后可适用：对一名其他玩家造成1点热忱属性伤害并回复自身1点同步值；使用攻击卡和技能卡之后立刻抽一张并让下次造成的热忱属性最终伤害+1（该效果一回合一次）。",
      "sp": "队伍初始攻击力+1，三名都是热忱属性角色还会额外+1。队伍造成热忱属性伤害后回复1点音韵值（一回合一次）。这个效果即使作为队员编组也会生效。这个效果会与其他队员的编组类效果冲突。",
      "score": 7.9,
      "grade": "A+",
      "archetypes": [
        "热忱快攻队"
