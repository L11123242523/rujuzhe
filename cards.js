window.__CARD_DATA__ = {
  ...
  "rules": {
    ...
    "attack_power_divide_2": "攻击力数值÷2向下取整才是实际伤害加成（每2点攻击力+1伤害，不足2点不增加）",
    "tile_range_include_self": "前方/前后N格内等范围均包含使用者自己所在的这一格（同格目标视为在范围内；但“其他玩家”类描述仍排除使用者本人）",
  ...
  "characters": [
    ...
    },
    {
      ...
      "sp": "①乐曲α，回复4点音韵值并抽1张②乐曲β，执行一次献祭动作，且那次献祭回复的音韵值+1③乐曲γ，回复4点同步值并抽取一张[馈赠卡]④乐曲δ，本回合献祭次数+1，那之后对一名其他玩家造成3点理智属性伤害。",
      "score": 7.8,
      "grade": "A+",
      "archetypes": [
        "资源运转队",
    ...
    },
    {
      "name": "琉璃(水着)",
      "attribute": "热忱",
      "passive": "为君绽放的微笑：使用热忱属性的卡后可适用：对一名其他玩家造成1点热忱属性伤害并回复自身1点同步值；使用攻击卡和技能卡之后立刻抽一张并让下次造成的热忱属性最终伤害+1。",
      ...
      "brief": "强势，热忱快攻队核心：用热忱卡造1热忱伤并回1同步，用攻击/技能卡抽1并让下次热忱最终伤害+1（滚雪球）；SP按热忱角色数加初始攻击力、热忱造伤回1音韵，队员位也生效（编组类，互斥）。同步值6。"
    },
    {
      "name": "露璐缇雅·爱德华",
      "attribute": "理智",
    ...
    },
    {
      ...
      "sp": "全队判定伤害+1，每有1名无序属性成员全队自然回复音韵+1。",
      "score": 7.8,
      "grade": "A+",
      "archetypes": [
        "判定伤害队"
      ...
      "combo_notes": "适用判定伤害队。予被动初始20%控骰+编组特定角色提升控骰，SP全队判定伤害+1（仅作为队长编组时生效，队员位不生效），是判定伤害队的核心队长。搭配琉璃（判定伤害后回音韵+累计全队判定+1）形成判定增伤循环。搭配钢笔（判定伤害+1+减费）、蓝宝之杖·命（追加判定伤害）、破损电子设备（低费判定伤害）。注意：20面骰和碰碰冰茶会降低判定伤害，判定伤害队不要带。",
      "roles": [
        "输出",
        "防御",
        "辅助"
